    ...
    if os.path.isdir(os.path.join(data_root, town_name)):
        ...
        # for seq_name in ['Town01_300']:
            if os.path.isdir(os.path.join(town_dir, seq_name)):
                for config_folder, config_name in zip(['streetsurf', 'streetsurf_no_lidar', 'streetsurf_no_rgb'],['withmask_withlidar_withnormal_all_cameras', 'withmask_withnormal_all_cameras', 'onlylidar_all_cameras']):
                # for config_folder, config_name in zip(['streetsurf_no_lidar', 'streetsurf_no_rgb'],['withmask_withnormal_all_cameras', 'onlylidar_all_cameras']):
                    ...
                    ckpt_dir = os.path.join('/data/huyb/cvpr-2024/neuralsim/logs/ss3dm/streetsurf/{}/{}/ckpts'.format(seq_name, config_name))
                    ...
                    save_mesh_dir = '/data/huyb/cvpr-2024/neuralsim/logs/ss3dm/streetsurf/{}/{}/meshes'.format(seq_name, config_name)
